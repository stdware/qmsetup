...
function(qtmediate_add_translation _target)
    set(options)
    ...
    if(_src_files)
        ...
        _qtmediate_add_lupdate_target(${_target}_lupdate
            INPUT ${_src_files}
            OUTPUT ${_ts_files}
            ${_ts_options}
            CREATE_ONCE
    ...
    # list(APPEND _qm_depends DEPENDS ${_target}_lupdate)
        ...
        if(FUNC_TS_DEPENDS)
            message(WARNING "ck_add_translations: no source files collected, TS_DEPENDS ignored")
        endif()
    endif()
    ...
    _qtmediate_add_lrelease_target(${_target}_lrelease
...
function(_qtmediate_add_lupdate_target _target)
...
function(_qtmediate_add_lrelease_target _target)
    set(options)
